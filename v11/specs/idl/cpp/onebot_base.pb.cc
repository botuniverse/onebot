...
extern PROTOBUF_INTERNAL_EXPORT_onebot_5fbase_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Message_DataEntry_DoNotUse_onebot_5fbase_2eproto;
namespace onebot {
...
static void InitDefaultsscc_info_Message_onebot_5fbase_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Message_onebot_5fbase_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Message_onebot_5fbase_2eproto}, {
      &scc_info_Message_DataEntry_DoNotUse_onebot_5fbase_2eproto.base,}};

static void InitDefaultsscc_info_Message_DataEntry_DoNotUse_onebot_5fbase_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Message_DataEntry_DoNotUse_onebot_5fbase_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Message_DataEntry_DoNotUse_onebot_5fbase_2eproto}, {}};
...
const char descriptor_table_protodef_onebot_5fbase_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_onebot_5fbase_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_onebot_5fbase_2eproto_sccs[2] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_onebot_5fbase_2eproto = {
  false, false, descriptor_table_protodef_onebot_5fbase_2eproto, "onebot_base.proto", 146,
  &descriptor_table_onebot_5fbase_2eproto_once, descriptor_table_onebot_5fbase_2eproto_sccs, descriptor_table_onebot_5fbase_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_onebot_5fbase_2eproto::offsets,
  file_level_metadata_onebot_5fbase_2eproto, 2, file_level_enum_descriptors_onebot_5fbase_2eproto, file_level_service_descriptors_onebot_5fbase_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_onebot_5fbase_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_onebot_5fbase_2eproto)), true);
namespace onebot {
...
void Message::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Message_onebot_5fbase_2eproto.base);
  type_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
